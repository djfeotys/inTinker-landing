<template>
  <div class="max-w-sm sm:max-w-lg m-auto mt-20">
    <div class="flex flex-col gap-x-[50px] sm:flex-row">
      <div class="sm:w-5/12" v-scroll-reveal.reset="{ origin: 'left', distance: '30px', delay: 500, }">
      ...
      <div class="sm:w-7/12" v-scroll-reveal.reset="{ origin: 'right', delay: 1000, }">
    ...
    <div v-scroll-reveal.reset="{ origin: 'left', distance: '30px', delay: 500, }">
      ...
      <div class=" sm:w-5/12" v-scroll-reveal.reset="{ origin: 'left', distance: '30px', delay: 500, }">
        <div class="flex flex-col gap-x-3 sm:items-center sm:flex-row">
          ...
          <div class="flex items-center border-b-2 border-black w-[130px] mt-4 sm:mt-0">
            <p class="text-[18px] font-semibold cursor-pointer" @click="handleClick">
              How it works
            </p>
            <ChevronRightIcon class="h-5 w-5 text-black-500" />
          </div>
        </div>
      </div>
      <div class="w-7/12 flex flow-row items-center gap-x-6 hidden sm:flex"
        v-scroll-reveal.reset="{ origin: 'right', delay: 1000, }">
    ...
    <div class="flex flex-row gap-x-10 items-center justify-between  mt-10 sm:justify-center"
      v-scroll-reveal.reset="{ origin: 'bottom', delay: 1300, }">
      <a href="https://www.3dnatives.com/en/ai-softwares-in-3d-printing2007234/#!"><img src="/image 47.svg"></a>
      <a href="https://howto3dprint.net/pioneering-ai-software-transforming-the-world-of-3d-printing/"><img
          src="/image 48.svg"></a>
    </div>
  </div>
</template>
...
export default {
  methods: {
    handleClick() {
      ...
      const position = htmlDocument.getElementById("section7").offsetTop;
      // smooth scroll
